        ...
        <View style={styles.container}>
            ...
            <View style={styles.cajaCuerpo}>
                ...
                <View style={styles.caja}>
                    <View style={styles.label}><StyledText small color={theme.colors.inputcolor}>Correo</StyledText></View>
                    <Input
                ...
                <View style={styles.caja}>
                    <View style={styles.label}><StyledText small color={theme.colors.inputcolor}>Contraseña</StyledText></View>
                    <Input
                        value={password}
